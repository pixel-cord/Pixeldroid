...
async function initializePixelcord() {
    try {
...
if (typeof window.__r === "undefined") {
    ...
    // It is too late to late to hook __r, so we just initialize Pixelcord here
