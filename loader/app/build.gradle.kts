...
android {
    ...
    defaultConfig {
        applicationId = "br.com.pixelcord.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"Pixelcord\"")
        buildConfigField("String", "MANAGER_NAME", "\"PixelcordManager\"")
        buildConfigField("String", "REPO", "\"pixel-cord/Pixeldroid\"")
        buildConfigField("String", "ORG_LINK", "\"https://github.com/pixel-cord\"")
        buildConfigField("String", "INVITE_LINK", "\"https://discord.gg/fsQUk9m5MS\"")
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"br.com.pixelcord\"")
        // Fundo do ícone do Discord modificado (Clyde branca sobre azul Pixelcord)
        buildConfigField("int", "MODDED_APP_ICON", "0xFF0D1B2A")
        buildConfigField("int", "MODDED_APP_ICON_ALPHA", "0xFF1B3A5C")
        buildConfigField("int", "MODDED_APP_ICON_OTHER", "0xFF13263D")
